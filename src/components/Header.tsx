...
export default function Header() {
    ...
    return (
        <>
            <header className={`w-full sticky top-0 left-0 z-50 py-3 px-4 sm:px-8 font-heading text-xl flex items-center justify-between transition-all duration-300 ${
                isScrolled 
            ...
            >
                {/* Mobile Menu Drawer */}
                <nav
                    className={`fixed top-0 right-0 w-80 max-w-[85vw] h-full bg-gradient-to-br from-primary-blue to-accent-navy shadow-2xl flex flex-col pt-24 px-6 transition-all duration-300 transform ${
