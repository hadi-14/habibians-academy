            ...
            <div className="space-y-3">
              {upcomingMeetings.map((meeting, index) => {
                ...
                return (
                  <div
                    key={meeting.uid}
                    className={`group relative overflow-hidden rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg ${isFirst
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                          <a
                            ...
                            className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${isFirst
