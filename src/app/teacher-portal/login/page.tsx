        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-primary-white to-blue-50 font-body">
            ...
            <div className="flex flex-col items-center mb-8 -mt-16">
                <Image
                    ...
                    className="mb-4"
                />
                <h1 className="text-4xl font-extrabold text-primary-blue mb-2 tracking-tight">Teacher Portal Login</h1>
                <p className="text-lg text-gray-600">Sign in to access your teacher dashboard.</p>
            </div>
